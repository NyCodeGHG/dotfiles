...
resource "cloudflare_record" "irc_marie_cologne" {
  zone_id = data.cloudflare_zone.marie_cologne.id
  name    = "irc"
  content = "artemis.marie.cologne"
  type    = "CNAME"
...
resource "cloudflare_record" "tsp_marie_cologne" {
  zone_id = data.cloudflare_zone.marie_cologne.id
  name    = "tsp"
  content = "artemis.marie.cologne"
  type    = "CNAME"
...
resource "cloudflare_record" "immich_marie_cologne" {
  zone_id = data.cloudflare_zone.marie_cologne.id
  name    = "immich"
  content = "marie-nas.marie.cologne"
  type    = "CNAME"
...
resource "cloudflare_record" "esphome_marie_cologne" {
  zone_id = data.cloudflare_zone.marie_cologne.id
  name    = "esphome.home"
  content = "marie-nas.marie.cologne"
  type    = "CNAME"
